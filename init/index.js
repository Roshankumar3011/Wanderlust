...
const MONGO_URL = "mongodb+srv://suku:suku123@cluster0.jjl0afc.mongodb.net/wanderlust?retryWrites=true&w=majority&appName=Cluster0";
...
const initDB = async () => {
    ...
    initdata.data = initdata.data.map((obj) => ({ ...obj, owner: "6873cd1608dcc1774af4e0f0", category: "Trending" }));
